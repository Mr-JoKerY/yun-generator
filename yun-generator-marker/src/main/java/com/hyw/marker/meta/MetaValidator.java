...
import com.hyw.marker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "hyw");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.hyw");
